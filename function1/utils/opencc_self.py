...
# CONFIG_DIR = 'data/opencc/config'
# DICT_DIR = 'data/opencc/dictionary'
...
class OpenCC:
    def __init__(self, conversion=None, CONFIG_DIR=None, DICT_DIR=None):
        """
        init OpenCC
        ...
        self.CONFIG_DIR = 'data/opencc/config'
        self.DICT_DIR = 'data/opencc/dictionary'
    ...
    def _init_dict(self):
        ...
        config_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), self.CONFIG_DIR, config)
    ...
    def _add_dict_chain(self, dict_chain, dict_dict):
        ...
        if dict_dict.get('type') == 'group':
            ...
            dict_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), self.DICT_DIR, filename)
